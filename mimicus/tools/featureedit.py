...
class FeatureEdit(object):
    ...
    def retrieve_feature_vector(self):
        ...
        name.
        '''
        features = sorted(list(self.retrieve_feature_dictionary().items()), key=operator.itemgetter(0))
...
+0000'.format(Y=YYYY, m=MM, d=DD, H=HH1, M=mm1, S=SS, sign=tz_sign, zH=HH2, zM=mm2)
    ...
    def get_pdfid0_lc(self):
        return len(list(filter(str.islower, self.__get_pdfid0())))

    @CachedMethod
    def get_pdfid0_uc(self):
        return len(list(filter(str.isupper, self.__get_pdfid0())))

    @CachedMethod
    def get_pdfid0_num(self):
        return len(list(filter(str.isdigit, self.__get_pdfid0())))
    ...
    def get_pdfid1_lc(self):
        return len(list(filter(str.islower, self.__get_pdfid1())))

    @CachedMethod
    def get_pdfid1_uc(self):
        return len(list(filter(str.isupper, self.__get_pdfid1())))

    @CachedMethod
    def get_pdfid1_num(self):
        return len(list(filter(str.isdigit, self.__get_pdfid1())))
    ...
    def get_title_lc(self):
        return len(list(filter(str.islower, self.__get_title())))

    @CachedMethod
    def get_title_uc(self):
        return len(list(filter(str.isupper, self.__get_title())))

    @CachedMethod
    def get_title_num(self):
        return len(list(filter(str.isdigit, self.__get_title())))
    ...
    def get_author_lc(self):
        return len(list(filter(str.islower, self.__get_author())))

    @CachedMethod
    def get_author_uc(self):
        return len(list(filter(str.isupper, self.__get_author())))

    @CachedMethod
    def get_author_num(self):
        return len(list(filter(str.isdigit, self.__get_author())))
    ...
    def get_producer_lc(self):
        return len(list(filter(str.islower, self.__get_producer())))

    @CachedMethod
    def get_producer_uc(self):
        return len(list(filter(str.isupper, self.__get_producer())))

    @CachedMethod
    def get_producer_num(self):
        return len(list(filter(str.isdigit, self.__get_producer())))
    ...
    def get_creator_lc(self):
        return len(list(filter(str.islower, self.__get_creator())))

    @CachedMethod
    def get_creator_uc(self):
        return len(list(filter(str.isupper, self.__get_creator())))

    @CachedMethod
    def get_creator_num(self):
        return len(list(filter(str.isdigit, self.__get_creator())))
    ...
    def get_subject_lc(self):
        return len(list(filter(str.islower, self.__get_subject())))

    @CachedMethod
    def get_subject_uc(self):
        return len(list(filter(str.isupper, self.__get_subject())))

    @CachedMethod
    def get_subject_num(self):
        return len(list(filter(str.isdigit, self.__get_subject())))
    ...
    def get_keywords_lc(self):
        return len(list(filter(str.islower, self.__get_keywords())))

    @CachedMethod
    def get_keywords_uc(self):
        return len(list(filter(str.isupper, self.__get_keywords())))

    @CachedMethod
    def get_keywords_num(self):
        return len(list(filter(str.isdigit, self.__get_keywords())))
...
#         return res if res else [0]
    ...
    def modify_file(self, features, dir='/tmp', verbose=False):
        ...
        if type(features) == list:
            features = dict(list(zip(FeatureDescriptor.get_feature_names(), features)))
            ...
            if features_current[feat] != feat_val and not isinstance(feat_val, Exception):
                if type(feat_val) == float and abs(features_current[feat] - feat_val) < 1e-6:
                    ...
                    if valid == True:
                        # Modify this feature
                        if verbose:
                            print(("Feature '%s' has to be changed from %s to %s" % (feat, features_current[feat], feat_val)))
        ...
        for (feat_prefix, feat_str) in list(_metadata_feats.items()):
            ...
            for feat_suffix in metadata_feats:
